...
### 1. 매 주 아래 순서대로 5문제 제출 (토요일 오전 10시 전)
...
> (필수) 프로그래머스 코테 예제 3문제 이상 풀이 후 정답 제출<p>

- 매 주 **토요일 오전 10시 전**까지 (필수) 문제 답 제출 (<- 출석 기준. 시도 흔적이라도 올려야함)
...
- 프로그래머스 LV.1 문제 중 정답률 70% 이하만 가능
...
- [전원] 토요일 오전 10시 전까지 문제푼 파이썬 파일 깃허브 업로드+PR
